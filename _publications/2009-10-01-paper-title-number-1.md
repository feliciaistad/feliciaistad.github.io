...
Sim, Y. W., **Istad, F.**, & Shin, J. H. (under review). When Tame Meets Wicked: Evidence of Deepening Labor Market Inequalities During Crisis.

Kim, S. Y., & **Istad, F.** (under review). Staying or Leaving after Graduation? Factors Shaping International Students’ Decision to Remain in South Korea. 

**Istad, F.** (under review). From Sojourners to Intermediaries: Migrants’ Transnational Engagement.

**Istad, F.**, & Kang, H. Y. (under review). Governing Children’s Presence in Everyday Urban Space.

Kang, H. Y. **Istad, F.**, Choi, Y. J., Kim H.E., & Chung, I.J. (work in progress). Do Institutions Care? Complex Trauma in Out-of-Home Care Leavers.

**Istad, F.**, Yeom, H.Y., Chesnut, M., & Curran, N.M. (work in progress). Linguistic Capital: Exploring the Role of Translanguaging in Migrant Integration.

**Istad, F.** (work in progress). Path Dependency and Policy Learning in Temporary Labor Migration.

Sim, Y.W., **Istad, F.**, Chung, K.H., & Shin, J.H. (work in progress). Procedural Legitimacy in AI Governance: Evidence from a Vignette Study in Germany.

Sim, Y.W., **Istad, F.**, Chung, K.H., & Shin, J.H. (work in progress). Administrative Capacity and AI Adoption in the Public Sector: Comparative Findings from a Survey Experiment in Korea and Japan.

Gibson, J., **Istad, F.**, & Lin, A.Y.T. (work in progress). Country Status and Foreign Policy Attitudes: Evidence from a Conjoint Experiment in the United States.
